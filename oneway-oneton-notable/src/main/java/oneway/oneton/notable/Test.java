package oneway.oneton.notable;

import oneway.oneton.notable.po.Address;
import oneway.oneton.notable.po.Person;
import oneway.oneton.notable.util.HibernateUtil;
import org.hibernate.Session;
import org.hibernate.Transaction;

/**
 * 单向1-N 无关联表 测试(一个人住在多个地址)
 */
public class Test {
