package bothway.oneton.withtable;

import bothway.oneton.withtable.po.Address;
import bothway.oneton.withtable.po.Person;
import bothway.oneton.withtable.util.HibernateUtil;
import org.hibernate.Session;
import org.hibernate.Transaction;

/**
 * 双向1-N 有关联表 测试(一个人住在多个地址)  双向表示既可以从Person对象中获取Address,反相也成立
 */
public class Test {
